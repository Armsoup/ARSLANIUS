...
cls
echo [  WAIT  ] BarOS Kernel 17.0 (%os_name%) starting...
timeout /t 1 >nul
...
echo OS_NAME = ARSLANIUS 20 > "%reg_path%"
...
set "user_home=%sys_prof%"
cd /d "%user_home%" 2>nul
echo [%date% %time%] BOOT_V20_INIT_%current_user% >> "%log_path%" 2>nul
cls
color 5b
echo ========================================
...
echo [ STATS ] Kernel: BarOS 17.0 (V20)
