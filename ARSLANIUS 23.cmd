...
cls
echo ======================================================================================================================
echo                                                 Loading ARSLANIUS 23
echo         Build: %current_build%
echo         Kernel: BarOS 19.0
echo ======================================================================================================================
...
set "user_home=%sys_prof%"
cd /d "%user_home%" 2>nul
echo [%date% %time% INFO] BOOT_V23_INIT_%current_user% >> "%log_path%" 2>nul
cls
color 5b
echo ======================================================================================================================
...
:check_r
set "is_ok=0"
for %%a in (Help logout backup backup-restore passwd reboot_to_recovery lock ArsStore NoteLite Snake sysinfo Scanner fmx restore restore-point mail-send mail-read clean report cls ver whoami Calc Notepad miner.game reboot shutdown) do (if /i "%ex_c%"=="%%a" set "is_ok=1")
...
echo [ STATS ] Kernel: BarOS 19.0 (V23)
...
echo System: Help, Logout, Lock, sudo, cls, Shutdown, ver, fmx, whoami, reboot, clean, service, events, restore-point, restore, passwd, backup, backup-restore
