...
cls
echo ======================================================================================================================
echo                                                 Loading ARSLANIUS 25
echo         Build: %current_build%
echo         Kernel: BarOS 21.0
echo ======================================================================================================================
...
echo OS_NAME = ARSLANIUS 25 > "%reg_path%"
...
set "user_home=%sys_prof%"
cd /d "%user_home%" 2>nul
echo [%date% %time% INFO] BOOT_V25_INIT_%current_user% >> "%log_path%" 2>nul
cls
color 5b
echo ======================================================================================================================
...
if /i "%current_user%"=="GUEST" (
    set "ok=0"
    for %%a in (Help logout ls cd support report cls ver dir whoami Calc Notepad miner.game reboot shutdown) do (if /i "%ex_c%"=="%%a" set "ok=1")
...
if errorlevel 1 (
    ...
    echo [ OK ] Directory changed to %cd%
)
